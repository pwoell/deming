...
return [
    'welcome' => [
         ...
         'controls' => 'Prüfungen',
         'action_plans' => "Aktionspläne",
         'next_controls' => 'Zeigt die Prüfplanung der nächsten 30 Tage',
         'control_status' => 'Prüfungsstatus',
         'control_planning' => 'Prüfplanung',
    ],
     'action' => [
        'index' => 'Aktionspläne',
        'show' => 'Aktionsplan',
    ...
    'attribute' => [
     ...
     'control' => [
         ...
         'fields' => [
            ...
            'choose_clause' => 'Wähle Referenz',
            'domain' => 'Domäne',
            'indicator' => 'Bewertungskala',
            'measure' => 'Maßnahme',
            'model' => 'Prüfschritte',
            'name' => 'Name',
            'next' => 'Nächstes',
        ...
        'error' => [
         ...
         'show' => 'Kontrollmassnahme',
         'plan_table' => 'Prüfplan',
         'index' => 'Liste Kontrollmassnahmen',
         'list' => 'Liste der Maßnahmen',
         'edit' => 'Kontrollmassnahme ändern',
         'history' => 'Zeitplan',
     ...
     'measure' => [
         ...
         'fields' => [
             ...
             'attributes' => 'Attribute',
             'model' => 'Prüfschritte',
             'indicator' => 'Verbesserungs- vorschläge',
             'action_plan' => 'Aktionsplan / Empfehlung',
             'periodicity' => 'Wiederholung',
             'input' => 'Nachweise',
             'observations' => 'Feststellungen',
             'evidence' => 'Nachweis',
             'owners' => 'Verantwortlicher',
             'score' => 'Bewertung',
             'planned' => 'geplant',
             'realized' => 'erledigt am',
             'next' => 'nächste',
             'plan_date' => 'geplant',
             'realisation_date' => 'erledigt am',
         ],
         'show' => 'Maßnahmen',
         'list' => 'Übersicht Prüfungen / Audits',
         'index' => 'Liste der Maßnahmen',
         'create' => 'Erstelle eine Maßnahme',
         'edit' => 'Prüfung / Audit ändern',
    ...
    'imports' => [
	 ...
	 'remove_all' => 'Lösche alle anderen Maßnahmen und Kontrollen',
         ...
         'clause' => 'Referenz',
         'clause_helper' => 'Wenn die Referenz existiert, wird die Sicherheitsmaßnahme aktualisiert,<br>wenn die Referenz nicht exisitiert, wird eine neue Sicherheitsmaßnahme erstellt,<br>wenn alle anderen Felder der Zeile leer sind, werden die Maßnahme, die zugehörigen Kontrollen und alle Dokumente entfernt.<br>',
         'name' => 'Name',
